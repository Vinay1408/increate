...
class SchemaBuilder {
    constructor(config) {
        ...
        if (!this.plugins.find((f) => f.config.name === 'declarativeWrapping')) {
            this.plugins.push(plugins_1.declarativeWrappingPlugin({ shouldWarn: true }));
        }
        ...
        interfaces.forEach((i) => {
            ...
            Object.keys(config.fields).forEach((field) => {
                ...
                if (modifications[field]) {
                    const _a = modifications[field], { type, field: _field, args } = _a, rest = tslib_1.__rest(_a, ["type", "field", "args"]);
    ...
    addDynamicScalar(methodName, typeName, block) {
        ...
        block[methodName] = (fieldName, opts) => {
            ...
            if (typeof opts === 'function') {
                console.warn(messages_1.messages.removedFunctionShorthand(block.typeName, fieldName));
                // @ts-ignore
