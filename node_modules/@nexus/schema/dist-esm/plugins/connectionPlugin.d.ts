...
import { ArgsValue, FieldTypeName, GetGen, MaybePromise, MaybePromiseDeep, ResultValue, RootValue } from '../typegenTypeHelpers';
...
export declare const ForwardOnlyStrictArgs: {
    first: NexusNonNullDef<any> | (import("../definitions/args").NexusArgDef<"Int"> & import("graphql").GraphQLNonNull<any>);
    after: NexusNullDef<any>;
};
...
export declare const BackwardOnlyStrictArgs: {
    last: NexusNonNullDef<any> | (import("../definitions/args").NexusArgDef<"Int"> & import("graphql").GraphQLNonNull<any>);
    before: NexusNullDef<any>;
};
export declare type EdgeFieldResolver<TypeName extends string, FieldName extends string, EdgeField extends string> = (root: RootValue<FieldTypeName<FieldTypeName<TypeName, FieldName>, 'edges'>>, args: ArgsValue<TypeName, FieldName>, context: GetGen<'context'>, info: GraphQLResolveInfo) => MaybePromise<ResultValue<TypeName, FieldName>['edges'][EdgeField]>;
